...
2. Run `npm init`. When that's finished, install and save these npm packages:
   ...
   3. mongoose activity 18

   4. cheerio activity 5
...
8. [Watch this demo of a possible submission](https://youtu.be/4ltZr3VPmno). See the deployed demo application [here](http://nyt-mongo-scrape1r.herokuapp.com/).
